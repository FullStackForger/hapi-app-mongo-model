...
externals.register = function (options) {
	...
	model = Hoek.merge({
		_config: config,
		_db : function () { return externals.db; }
	}, helpers);
	...
	/* todo: consider alternative exposing methods to avoid delayed requiring models drawbacks
	for (var method in 	Monk.Collection.prototype) {
		if (typeof(Monk.Collection.prototype[method]) === 'function') {
			collectionApi[method] = (function (method) {
				return function() {
					Monk.Collection.prototype[method].call(self, arguments);
				};
			}) (method);
		}
	}
	*/
	...
	collectionApi.db = function () { return externals.db;}
